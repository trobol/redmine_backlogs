    ...
    def self.perform
      Issue.class_eval do
        ...
        def self.release_notes_required
          done_value = Backlogs.setting["field_value_done"]
          todo_value = Backlogs.setting["field_value_todo"]
          joins_release_notes.
        ...
        def self.release_notes_none
          none_value = Backlogs.setting["field_value_not_required"]
          joins_release_notes.
        ...
        def self.release_notes_not_required
          cf_id = Backlogs.setting["issue_custom_field_id"].to_i
          none_value = Backlogs.setting["field_value_not_required"]
